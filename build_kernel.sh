...
BUILD_CROSS_COMPILE=/home/flatty/aarch64-linux-android-4.9/bin/aarch64-linux-android-
KERNEL_LLVM_BIN=/home/flatty/6.0/bin/clang
KERNEL_LLVM_CFP=/home/flatty/6.0-cfp/bin/clang
...
PROC="$(($(nproc) + 1))"
test -z "$ANDROID_VERSION" && ANDROID_VERSION=990000

make -j$PROC -C $(pwd) O=$(pwd)/out $KERNEL_MAKE_ENV ARCH=arm64 CROSS_COMPILE=$BUILD_CROSS_COMPILE REAL_CC=$KERNEL_LLVM_BIN CFP_CC=$KERNEL_LLVM_CFP CLANG_TRIPLE=$CLANG_TRIPLE ANDROID_VERSION="$ANDROID_VERSION" beyond2qlte_chn_hk_defconfig
